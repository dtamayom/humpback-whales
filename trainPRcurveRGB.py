...
from DataloaderRGB import DatasetJorobadas
...
train_masks=os.listdir('../data/HumpbackWhales/train_final_masks/')
...
val_masks=os.listdir('../data/HumpbackWhales/val_final_masks/')
...
test_im=os.listdir('../data/HumpbackWhales/test_final_masks/')
...
train_loader = torch.utils.data.DataLoader(DatasetJorobadas(train_im, train_masks, train, '../data/HumpbackWhales/train_final/',
                  image_transforms['train']),batch_size=args.batch_size, shuffle=True, **kwargs)


val_loader = torch.utils.data.DataLoader(DatasetJorobadas(val_im, val_masks, val, '../data/HumpbackWhales/val_final/', 
